...
<head>
    ...
    <title>gar-eigenaar-met-auto.php</title>
</head>

<div>
<body>
    <h1>Klant en Auto</h1>
    <p>Dit document wordt gebruikt om te kijken/lezen van wie welke auto is.</p>
    <div class="klantauto">
    <?php
            require_once "gar-connect.php";
 
            $autos= $conn->prepare("SELECT     k.klantnaam, a.autokenteken,
                                                 a.automerk, a.autotype,
                                                k.klantid, a.autokmstand 
                                      FROM       klant k
